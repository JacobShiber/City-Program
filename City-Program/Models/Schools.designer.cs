...
namespace City_Program.Models
{
	...
	public partial class School : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _StudentsAmount;
    ...
    partial void OnStudentsAmountChanging(System.Nullable<int> value);
    partial void OnStudentsAmountChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StudentsAmount", DbType="Int")]
		public System.Nullable<int> StudentsAmount
		{
			get
			{
				return this._StudentsAmount;
			}
			set
			{
				if ((this._StudentsAmount != value))
				{
					this.OnStudentsAmountChanging(value);
					this.SendPropertyChanging();
					this._StudentsAmount = value;
					this.SendPropertyChanged("StudentsAmount");
					this.OnStudentsAmountChanged();
				}
			}
		}
